...
class ReducedCacheModel(RecurrentNetwork, nn.Module):
    """
...
def test_sanity(model_config):
    ...
    model = ReducedCacheModel(env.observation_space, env.action_space, env.action_space.n, model_config, 'test')
...
def test_trainonebatch():
    ...
    ModelCatalog.register_custom_model("cnn_model", ReducedCacheModel)
